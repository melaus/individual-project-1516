...
% title
\title{\textbf{Using Supervised Machine-learning Techniques to Perform Mutilclass Classification using Depth Data}}
\author{Alan Lau}
...
\declaration{Using Supervised Machine-learning Techniques to Perform Mutilclass Classification using Depth Data}{Alan Lau}
\newpage
